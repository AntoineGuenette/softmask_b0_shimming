...
echo -e "\n--- RUNNING SEGMENTATION AND BINARY MASK ---\n"
../experiment_scripts/bin_seg_shim.sh /Users/antoineguenette/Desktop/démonstration_projet_III/Sujets/01 01 25 9 1
...
echo -e "\n--- RUNNING SEGMENTATION AND BINARY MASK ---\n"
../experiment_scripts/bin_seg_shim.sh /Users/antoineguenette/Desktop/démonstration_projet_III/Sujets/02 02 25 9 1
echo -e "\n--- RUNNING 2 LEVELS SOFTMASK ---\n"
